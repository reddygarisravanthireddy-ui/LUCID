...
function applyEvidenceConsistency(result, rawText, mode) {
  ...
  // If technical reasoning indicates benign/safe documentation but verdict or severity is elevated, downgrade.
  ...
  if (hasBenignReasoningPhrase && (isDangerous || isHighOrCritical)) {
