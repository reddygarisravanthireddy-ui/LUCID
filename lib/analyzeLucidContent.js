...
- Never classify a message, alert, email, screenshot, or log as phishing, malicious, or suspicious solely because of a displayed date/time.
- Account for timezone offsets, device clock differences, delayed alerts, ingestion delays, and formatting differences.
- A date/time inconsistency may be noted as an anomaly only when it can be confidently established from the supplied reference time.
- Even a genuine temporal anomaly is contextual evidence, not by itself proof of phishing.
